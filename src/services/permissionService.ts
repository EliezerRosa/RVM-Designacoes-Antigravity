...
const FALLBACK_PERMISSIONS: ResolvedPermissions = {
    ...
    agentActions: new Set(['CHECK_SCORE', 'EXPLAIN_SCORE', 'EXPLAIN_PART', 'FETCH_DATA', 'GET_ANALYTICS', 'NAVIGATE_WEEK', 'VIEW_S140', 'SHOW_MODAL']),
...
const FULL_ADMIN_PERMISSIONS: ResolvedPermissions = {
    ...
    agentActions: new Set<string>([
        ...
        'SHARE_S140_WHATSAPP', 'CHECK_SCORE', 'EXPLAIN_SCORE', 'EXPLAIN_PART', 'CLEAR_WEEK', 'UPDATE_PUBLISHER',
