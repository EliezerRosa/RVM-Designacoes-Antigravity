...
const ALL_ACTIONS = [
    ...
    'SHARE_S140_WHATSAPP', 'CHECK_SCORE', 'EXPLAIN_SCORE', 'EXPLAIN_PART', 'EXPLAIN_RANKING', 'GET_ENGINE_RULES', 'GET_ELIGIBILITY_VERSION', 'CLEAR_WEEK', 'CLEAR_RANGE', 'UPDATE_PUBLISHER',
    ...
    'MANAGE_PERMISSIONS', 'QUERY_PUBLISHER_ASSIGNMENTS', 'QUERY_WEEK_ASSIGNMENTS',
    'QUERY_VACANT_PARTS', 'QUERY_ELIGIBILITY', 'QUERY_PUBLISHER_PROFILE', 'QUERY_PUBLISHER_LIST'
] as const;
