...
export function ZApiMemberSearchPanel() {
    ...
    const handleBindAndSave = async (waPhone: string, pubId: string) => {
        ...
        try {
            ...
            // Nota: rm.publishers (schema RM/Glide) não possui coluna phone e seu id
            // é um uuid próprio (não o mesmo id text de public.publishers), por isso
            // não há espelhamento de telefone nessa tabela.
