...
export function LoginPage() {
  const { user, needs2FA, authSystemMode, signInWithGoogle, signInWithDeviceAuth, requestWhatsAppCode, verifyWhatsAppCode, signOut } = useAuth();
      ...
      <div style={styles.card}>
        ...
        <p style={styles.footer}>
          {authSystemMode === 'device_biometric'
            ? 'Acesso seguro por biometria, FaceID, TouchID ou PIN do seu dispositivo.'
            : 'Acesso rápido e seguro para membros autorizados da congregação.'}
        </p>
      </div>
    </div>
  );
