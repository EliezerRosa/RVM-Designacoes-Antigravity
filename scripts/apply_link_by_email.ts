...
const sqlPath = join(__dirname, '..', 'supabase', 'migrations', '20260424000000_link_publisher_by_email.sql');
...
async function run() {
    console.log('Aplicando migração link_publisher_by_email via exec_sql...');
