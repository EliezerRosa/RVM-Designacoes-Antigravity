...
BEGIN
    ...
    FOR i IN 0..11 LOOP
        ...
        SELECT 
            ...
            COALESCE((SELECT is_open = false FROM rm.month_control mc WHERE mc.reference_year = v_year AND mc.reference_month = v_month AND mc.congregation_id = p_congregation_id LIMIT 1), false)::boolean
        FROM (SELECT 1) dummy
